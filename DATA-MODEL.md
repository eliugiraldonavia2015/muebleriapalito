...
| `qrUrl` | string (optional) | URL para generar un QR; si existe, se muestra el QR sobrepuesto en la imagen del producto |
| `specsText` | string (optional) | Texto libre de especificaciones; si existe, aparece el boton "Ver especificaciones" en la pagina de producto |
